...
('INV-A008',@bid1,@uid1,'Solomon Alemu','0977890123',430.00,20.00,430.00,'mobile_money','completed',DATE_SUB(NOW(),INTERVAL 4 DAY)),
...
('INV-A011',@bid1,@uid1,'Kidus Mekonnen','0999012345',280.00,0,280.00,'mobile_money','completed',DATE_SUB(NOW(),INTERVAL 6 DAY)),
...
('INV-A018',@bid3,@uid1,'Meron Tadesse','0944567890',300.00,30.00,300.00,'mobile_money','completed',DATE_SUB(NOW(),INTERVAL 15 DAY)),
