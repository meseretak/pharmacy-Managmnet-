...
// ---- MEDICINE BREAKDOWN for selected date ----
$dayMeds = [];
try {
...
// ---- STAFF BREAKDOWN for selected date ----
$staffBreakdown = [];
try {
...
<div class="stats-grid" style="grid-template-columns:repeat(5,1fr);margin-bottom:20px;">
    <div class="stat-card green">
        ...
        <div class="stat-info">
            <div class="value" style="font-size:18px;"><?= formatCurrency($totals['revenue']) ?></div>
    ...
    <div class="stat-card blue">
        ...
        <div class="stat-info">
            <div class="value"><?= number_format($totals['sales']) ?></div>
    ...
    <div class="stat-card red">
        ...
        <div class="stat-info">
            <div class="value" style="font-size:18px;"><?= formatCurrency($totals['discount']) ?></div>
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-bottom:20px;">
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-title"><i class="fas fa-calendar-day" style="color:var(--primary)"></i> Daily Breakdown</div>
        </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr style="background:var(--light);font-weight:700;border-top:2px solid var(--border);">
                        <td>TOTAL</td>
                        <td><?= $totals['sales'] ?></td>
                        <td><?= number_format($totals['items']) ?></td>
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-title">
                <i class="fas fa-pills" style="color:var(--info)"></i>
                Medicines Sold &mdash; <?= date('d M Y', strtotime($selectedDate)) ?>
            </div>
        </div>
...
<div class="card" style="margin-bottom:20px;">
    <div class="card-header">
        <div class="card-title">
            ...
            Sales by Staff &mdash; <?= date('d M Y', strtotime($selectedDate)) ?>
        </div>
        <a href="/pharmacy/reports/staff.php?date_from=<?= $dateFrom ?>&date_to=<?= $dateTo ?>&branch_id=<?= $branchId ?>" class="btn btn-outline btn-sm">
            <i class="fas fa-chart-bar"></i> Full Staff Report
        </a>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="min-width:120px;">
                        ...
                        <div class="progress">
                            <div class="progress-bar" style="width:<?= $share ?>%;background:<?= $colors[$i % 5] ?>"></div>
                        </div>
                    </td>
                </tr>
                <?php endforeach; ?>
...
<div class="card" style="margin-bottom:20px;">
    <div class="card-header">
        <div class="card-title"><i class="fas fa-chart-bar" style="color:var(--primary)"></i> Revenue, Profit &amp; Items Chart</div>
    </div>
    <div class="card-body">
